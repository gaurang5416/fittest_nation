        ...
        <div class="home-carousel owl-carousel owl-theme">
            <div class="item">
                <div class="banner-main position-relative">
                    <div class="banner-content"><span class="new-tag mb-4 wow fadeInDownBig">                    <small>New</small> High Intensity workout to burn calories                </span>
                        <h1 class="wow fadeInLeftBig"> Cardio<br>Exercise </h1>
                        <p class="wow fadeInLeftBig"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    ...
                    <div class="banner-right-div wow fadeInRightBig">
                        <div class="banner-img"><img src="<?php echo base_url(); ?>assets/img/banner-img.png" alt="img"
                                                     class="img-fluid"></div>
            ...
            <div class="item">
                <div class="banner-main position-relative">
                    ...
                    <div class="banner-right-div wow fadeInRightBig">
                        <div class="banner-img"><img src="assets/img/banner-img.png" alt="img" class="img-fluid"></div>
                        <div class="time-card-div">
                            <div class="timecard"><h3 class="text-yellow">38:14</h3>
                                <p>TIME</p></div>
                            <div class="timecard"><h3 class="text-pink">165</h3>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                    <div class="work-right-div wow fadeInRightBig"><p class="text-sec"> Lorem ipsum dolor sit amet,
                        ...
                        <div class="workbtndiv"><a href="<?php echo base_url(); ?>personal_trainer" class="btn btn-primary"> Get Started </a></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="aboutus-section default-padding">
    <div class="container">
        <div class="about-div bg-sec">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="about-content wow fadeinleft"><h1 class="mb-3">About Us</h1>
                        ...
                        <div class="aboutbtndiv"><a href="#" class="btn btn-primary"> Get Started </a></div>
                    </div>
                </div>
                <div class="col-md-6">
