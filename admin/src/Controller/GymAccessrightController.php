...
class GymAccessrightController extends AppController
{
	public function accessRight()
    {
		...
		if($this->request->is("post"))
		{
            ...
            //---------NEW MENU LINK START------------------
            $access_right['banner'] =array('menu_icone'=>'group.png' ,'menu_title'=>'Banner',
                'action'=>'',
                'member' => isset($request['member_banner'])?$request['member_banner']:0,
                'staff_member' =>isset($request['staff_member_banner'])?$request['staff_member_banner']:0,
                'accountant' =>isset($request['accountant_banner'])?$request['accountant_banner']:0,
                'page_link'=>$site_path.'/gym-banner/banner-list',
                'controller'=>"GymBanner");
