...
Class GYMfunctionComponent extends Component
{
    ...
    public function check_valid_extension($filename, $type = 'image')
    {
        $flag = 2;
        ...
        if ($filename != '') {
            ...
            if ($type === 'image') {
                ...
                $valid_extension = ['gif', 'png', 'jpg', 'jpeg', "", 'JPG', 'GIF', 'PNG', 'JPEG', 'mp4'];
            }
    ...
    public function get_file_type($filename)
    {
        if ($filename != '') {
            $ext = pathinfo($filename, PATHINFO_EXTENSION);
            if(in_array($ext, ['gif', 'png', 'jpg', 'jpeg', "", 'JPG', 'GIF', 'PNG', 'JPEG'])) {
                return 'image';
