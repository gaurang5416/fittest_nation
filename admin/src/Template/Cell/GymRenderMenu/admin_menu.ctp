...
<ul class="sidebar-menu">
    ...
    <li class="treeview <?php echo ($this->request->controller == "GymBanner") ? "active" : ""; ?>">
        <a href="<?php echo $this->Gym->createurl("GymBanner", "BannerList"); ?>">
            <i class="fa fa-object-group"></i> <span><?php echo __('Banner'); ?></span>
        </a>
    </li>
    ...
    <li class="treeview <?php echo ($this->request->controller == "GymPages") ? "active" : ""; ?>">
        <a href="<?php echo $this->Gym->createurl("GymPages", "PagesList"); ?>">
            <i class="fa fa-history"></i> <span><?php echo __('Pages'); ?></span>
        </a>
    </li>
    <li class="treeview <?php echo ($this->request->controller == "GymContactUs") ? "active" : ""; ?>">
        <a href="<?php echo $this->Gym->createurl("GymContactUs", "ContactUsList"); ?>">
            <i class="fa fa-history"></i> <span><?php echo __('Contact Us'); ?></span>
        </a>
    </li>
