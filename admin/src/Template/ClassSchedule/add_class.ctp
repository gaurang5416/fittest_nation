...
<section class="content">
    ...
    <div class="col-md-12 box box-default">
        ...
        <div class="box-body">
            ...
            echo "<div class='form-group'>";
            echo '<label class="control-label col-md-2" for="end time">' . __("Description") . '</label>';
            echo '<div class="col-md-6 ">';
            echo $this->Form->textarea('', array('label' => false, 'id' => 'description', 'name' => 'description', 'class' => 'form-control text-input', "value" => (($edit) ? $data['description'] : '')));
            echo "</div>";
            echo '</div>';

            echo "<div class='form-group'>";
            echo '<label class="control-label col-md-2" for="end time">' . __("Is popular") . '</label>';
            echo '<div class="col-md-6 ">';
            echo $this->Form->input('', array('type' => 'checkbox', 'checked' => (($edit) ? $data['is_popular'] : ''), 'id' => 'is_popular', 'name' => 'is_popular', "value" => '1'));
            echo "</div>";
            echo '</div>';

            echo "<div class='form-group'>";
            echo "<label class='control-label col-md-2'>" . __("Image") . "</label>";
            echo "<div class='col-md-6'>";
            ...
            echo "<div class='form-group'>";
            echo "<label class='control-label col-md-2'>" . __("Video") . "</label>";
            echo "<div class='col-md-6'>";
            ...
            if (isset($data['video']) && $data['video'] != "") {
                foreach (json_decode($data['video']) as $key => $video) {
                    ...
                    echo "<label style='display:none'></label>";
                    echo '<span onclick=removeOldVideo("' . $key . '","' . $video . '"); style="position: absolute; right: 5px; cursor: pointer"><i class="fa fa-times-circle"></i></span>';
                    echo "</div>";
                }
            }
            echo "</div>";
