        ...
        <div class="box-body">
            <form name="student_form" action="" method="post" class="form-horizontal" id="access_right_form">
				...
				<span class="menu-label">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-sm-3 col-xs-5">
				        <span class="menu-label"><?php echo __("Group"); ?></span>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-2">
                            <div class="checkbox text-center">
                                <label>
                    ...
                    <div class="row">
                        <div class="col-md-2 col-sm-3 col-xs-5">
                            <span class="menu-label"><?php echo __("Banner"); ?></span>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-2">
                            <div class="checkbox text-center">
                                <label>
                                    <input type="checkbox" <?php echo ($member["banner"]) ? "checked" : ""; ?> value="1" name="member_banner" readonly="">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-2">
                            <div class="checkbox text-center">
                                <label>
                                    <input type="checkbox" <?php echo ($staff_member["banner"]) ? "checked" : ""; ?> value="1" name="staff_member_banner" readonly="">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-3 col-xs-2">
                            <div class="checkbox text-center">
                                <label>
                                    <input type="checkbox" <?php echo ($accountant["banner"]) ? "checked" : ""; ?> value="1" name="accountant_banner" readonly="">
                                </label>
                            </div>
                        </div>
                    </div>
